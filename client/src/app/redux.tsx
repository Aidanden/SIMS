...
import { projectApi } from "@/state/projectApi"; // إضافة projectApi
...
const rootReducer = combineReducers({
  ...
  [projectApi.reducerPath]: projectApi.reducer, // إضافة projectApi.reducer
});
